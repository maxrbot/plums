...
export default function UsdaPricingPage() {
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div className="flex items-center">
                ...
                <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2">USDA Market Pricing</span>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">USDA Market Pricing</h1>
              <p className="text-gray-600">Current market prices for your crops based on USDA data</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center p-2 border border-gray-300 rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
