                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Add a new certification or quality standard for your agricultural operations.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
                    <div className="text-yellow-600">
                      ...
                      <p className="text-sm text-yellow-700 mb-4">
                        You need to add crops to your catalog before setting up certifications.
                        Certifications are applied to specific crops in your price sheets.
                      </p>
                      <button
                        type="button"
                        onClick={() => {
                  ...
                  <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-3">
                        Select which crops this certification applies to
                      </p>
